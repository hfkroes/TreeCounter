...
class StateListDrawable extends DrawableContainer {
    ...
    public void inflate(@NonNull Context context, @NonNull Resources r, @NonNull XmlPullParser parser, @NonNull AttributeSet attrs, @Nullable Theme theme) throws XmlPullParserException, IOException {
        TypedArray a = TypedArrayUtils.obtainAttributes(r, theme, attrs, C0205R.styleable.StateListDrawable);
        setVisible(a.getBoolean(C0205R.styleable.StateListDrawable_android_visible, true), true);
    ...
    private void updateStateFromTypedArray(TypedArray a) {
        ...
        state.mVariablePadding = a.getBoolean(C0205R.styleable.StateListDrawable_android_variablePadding, state.mVariablePadding);
        state.mConstantSize = a.getBoolean(C0205R.styleable.StateListDrawable_android_constantSize, state.mConstantSize);
        state.mEnterFadeDuration = a.getInt(C0205R.styleable.StateListDrawable_android_enterFadeDuration, state.mEnterFadeDuration);
        state.mExitFadeDuration = a.getInt(C0205R.styleable.StateListDrawable_android_exitFadeDuration, state.mExitFadeDuration);
        state.mDither = a.getBoolean(C0205R.styleable.StateListDrawable_android_dither, state.mDither);
    }
        ...
        while (true) {
            ...
            if (type2 != 1) {
                ...
                if (type2 == 2 && depth <= innerDepth && parser.getName().equals("item")) {
                    TypedArray a = TypedArrayUtils.obtainAttributes(r, theme, attrs, C0205R.styleable.StateListDrawableItem);
                    Drawable dr = null;
                    int drawableId = a.getResourceId(C0205R.styleable.StateListDrawableItem_android_drawable, -1);
                    if (drawableId > 0) {
