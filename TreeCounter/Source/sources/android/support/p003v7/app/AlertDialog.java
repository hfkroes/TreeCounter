...
public class AlertDialog extends AppCompatDialog implements DialogInterface {
    ...
    public static class Builder {
        ...
        public Builder setTitle(@StringRes int titleId) {
            this.f23P.mTitle = this.f23P.mContext.getText(titleId);
            return this;
        }
        ...
        public Builder setMessage(@StringRes int messageId) {
            this.f23P.mMessage = this.f23P.mContext.getText(messageId);
            return this;
        }
        ...
        public Builder setPositiveButton(@StringRes int textId, OnClickListener listener) {
            this.f23P.mPositiveButtonText = this.f23P.mContext.getText(textId);
            this.f23P.mPositiveButtonListener = listener;
            return this;
        }

        public Builder setPositiveButton(CharSequence text, OnClickListener listener) {
            this.f23P.mPositiveButtonText = text;
            this.f23P.mPositiveButtonListener = listener;
            return this;
        }
        ...
        public Builder setNegativeButton(@StringRes int textId, OnClickListener listener) {
            this.f23P.mNegativeButtonText = this.f23P.mContext.getText(textId);
            this.f23P.mNegativeButtonListener = listener;
            return this;
        }

        public Builder setNegativeButton(CharSequence text, OnClickListener listener) {
            this.f23P.mNegativeButtonText = text;
            this.f23P.mNegativeButtonListener = listener;
            return this;
        }
        ...
        public Builder setNeutralButton(@StringRes int textId, OnClickListener listener) {
            this.f23P.mNeutralButtonText = this.f23P.mContext.getText(textId);
            this.f23P.mNeutralButtonListener = listener;
            return this;
        }

        public Builder setNeutralButton(CharSequence text, OnClickListener listener) {
            this.f23P.mNeutralButtonText = text;
            this.f23P.mNeutralButtonListener = listener;
            return this;
        }
        ...
        public Builder setItems(@ArrayRes int itemsId, OnClickListener listener) {
            this.f23P.mItems = this.f23P.mContext.getResources().getTextArray(itemsId);
            this.f23P.mOnClickListener = listener;
            return this;
        }

        public Builder setItems(CharSequence[] items, OnClickListener listener) {
            this.f23P.mItems = items;
            this.f23P.mOnClickListener = listener;
            return this;
        }

        public Builder setAdapter(ListAdapter adapter, OnClickListener listener) {
            this.f23P.mAdapter = adapter;
            this.f23P.mOnClickListener = listener;
            return this;
        }

        public Builder setCursor(Cursor cursor, OnClickListener listener, String labelColumn) {
            this.f23P.mCursor = cursor;
            this.f23P.mLabelColumn = labelColumn;
            this.f23P.mOnClickListener = listener;
            return this;
        }
        ...
        public Builder setMultiChoiceItems(@ArrayRes int itemsId, boolean[] checkedItems, OnMultiChoiceClickListener listener) {
            this.f23P.mItems = this.f23P.mContext.getResources().getTextArray(itemsId);
            this.f23P.mOnCheckboxClickListener = listener;
            this.f23P.mCheckedItems = checkedItems;
            this.f23P.mIsMultiChoice = true;
            return this;
        }
        ...
        public Builder setMultiChoiceItems(Cursor cursor, String isCheckedColumn, String labelColumn, OnMultiChoiceClickListener listener) {
            this.f23P.mCursor = cursor;
            this.f23P.mOnCheckboxClickListener = listener;
            this.f23P.mIsCheckedColumn = isCheckedColumn;
            this.f23P.mLabelColumn = labelColumn;
            this.f23P.mIsMultiChoice = true;
            return this;
        }
        ...
        public Builder setSingleChoiceItems(@ArrayRes int itemsId, int checkedItem, OnClickListener listener) {
            this.f23P.mItems = this.f23P.mContext.getResources().getTextArray(itemsId);
            this.f23P.mOnClickListener = listener;
            this.f23P.mCheckedItem = checkedItem;
            this.f23P.mIsSingleChoice = true;
            return this;
        }
        ...
        public Builder setView(int layoutResId) {
            this.f23P.mView = null;
            this.f23P.mViewLayoutResId = layoutResId;
            this.f23P.mViewSpacingSpecified = false;
            return this;
        }

        public Builder setView(View view) {
            this.f23P.mView = view;
            this.f23P.mViewLayoutResId = 0;
            this.f23P.mViewSpacingSpecified = false;
            return this;
        }
        ...
        public Builder setView(View view, int viewSpacingLeft, int viewSpacingTop, int viewSpacingRight, int viewSpacingBottom) {
            this.f23P.mView = view;
            this.f23P.mViewLayoutResId = 0;
            this.f23P.mViewSpacingSpecified = true;
            this.f23P.mViewSpacingLeft = viewSpacingLeft;
            this.f23P.mViewSpacingTop = viewSpacingTop;
            this.f23P.mViewSpacingRight = viewSpacingRight;
            this.f23P.mViewSpacingBottom = viewSpacingBottom;
            return this;
        }
