...
public class SupportMenuInflater extends MenuInflater {
    ...
    private class MenuState {
        ...
        public void readItem(AttributeSet attrs) {
            ...
            this.itemCategoryOrder = (-65536 & a.getInt(C0205R.styleable.MenuItem_android_menuCategory, this.groupCategory)) | (65535 & a.getInt(C0205R.styleable.MenuItem_android_orderInCategory, this.groupOrder));
            ...
            this.itemAlphabeticModifiers = a.getInt(C0205R.styleable.MenuItem_alphabeticModifiers, 4096);
            this.itemNumericShortcut = getShortcut(a.getString(C0205R.styleable.MenuItem_android_numericShortcut));
            this.itemNumericModifiers = a.getInt(C0205R.styleable.MenuItem_numericModifiers, 4096);
            if (a.hasValue(C0205R.styleable.MenuItem_android_checkable)) {
                if (a.getBoolean(C0205R.styleable.MenuItem_android_checkable, false)) {
                    i = 1;
                } else {
                    i = 0;
                }
            ...
            this.itemContentDescription = a.getText(C0205R.styleable.MenuItem_contentDescription);
            this.itemTooltipText = a.getText(C0205R.styleable.MenuItem_tooltipText);
            if (a.hasValue(C0205R.styleable.MenuItem_iconTintMode)) {
                this.itemIconTintMode = DrawableUtils.parseTintMode(a.getInt(C0205R.styleable.MenuItem_iconTintMode, -1), this.itemIconTintMode);
            } else {
                this.itemIconTintMode = null;
            }
            if (a.hasValue(C0205R.styleable.MenuItem_iconTint)) {
                this.itemIconTintList = a.getColorStateList(C0205R.styleable.MenuItem_iconTint);
            } else {
