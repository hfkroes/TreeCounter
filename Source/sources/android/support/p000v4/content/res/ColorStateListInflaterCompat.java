...
public final class ColorStateListInflaterCompat {
    ...
    private static ColorStateList inflate(@NonNull Resources r, @NonNull XmlPullParser parser, @NonNull AttributeSet attrs, @Nullable Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (depth < innerDepth && type == 3) {
                ...
                TypedArray a = obtainAttributes(r, theme, attrs, C0019R.styleable.ColorStateListItem);
                int baseColor = a.getColor(C0019R.styleable.ColorStateListItem_android_color, Component.COLOR_MAGENTA);
                float alphaMod = 1.0f;
                if (a.hasValue(C0019R.styleable.ColorStateListItem_android_alpha)) {
                    alphaMod = a.getFloat(C0019R.styleable.ColorStateListItem_android_alpha, 1.0f);
                } else if (a.hasValue(C0019R.styleable.ColorStateListItem_alpha)) {
                    alphaMod = a.getFloat(C0019R.styleable.ColorStateListItem_alpha, 1.0f);
                }
                a.recycle();
                int j2 = 0;
                ...
                while (true) {
                    ...
                    if (stateResId == 16843173 || stateResId == 16843551 || stateResId == C0019R.attr.alpha) {
                        j2 = j;
                    } else {
                        j2 = j + 1;
    ...
    @ColorInt
    private static int modulateColorAlpha(@ColorInt int color, @FloatRange(from = 0.0d, mo96to = 1.0d) float alphaMod) {
